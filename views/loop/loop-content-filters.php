...
<div class="clearfix eggz-reservations-filters">
	...
	<ul class="reservations-filters">
		<li><button type="button" class="reservations-filter"><?php _e( 'All', 'eggz-reservations' ); ?></button></li>
		<li><button type="button" class="reservations-filter"><?php _e( 'Unassigned', 'eggz-reservations' ); ?></button></li>
	</ul>
